	...
	<div class="product-box light-bg">
		<div class="ribbon-small ribbon-red">
			<div class="ribbon-inner">
				<span class="ribbon-text">Sale <?php echo $rows->c_sale; ?>%</span>
				<span class="ribbon-aligner"></span>
			</div>
		</div>
		<a class="product-img" 
		href="index.php?controller=detail_product&id=<?php echo $rows->pk_product_id; ?>">
			<span><img src="public/upload/<?php echo $rows->c_img;?>" 
			alt="<?php echo $rows->c_name; ?>"/>
			</span>
		</a>
		<div class="product-info light-bg middle-border">
			<h3 class="product-title subheader-font">
				<a href="product/detail/<?php echo remove_unicode($rows->c_name)?>/
					<?php echo $rows->pk_product_id; ?>" class="dark-color active-hover">
